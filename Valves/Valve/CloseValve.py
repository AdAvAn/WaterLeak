...
class CloseValve(ValvePort):
    ...
    async def _operating_valve(self, width_progress:bool) -> None:
        ...
        self.reset_progress()
        self.start_valve()
        self.logger.debug(f"VALVE: Strt closing valve '{self.device_name}', {self.operation_time_left} sec remaining")
        ...
        self.logger.debug(f"VALVE: Finish closing valve '{self.device_name}'")
        self.stop_valve()
        self.clear_task()
